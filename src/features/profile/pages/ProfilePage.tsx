  ...
  return (
    <div className="h-[calc(100vh-6rem)] w-full flex flex-col gap-4">
      ...
      <div className="flex-1 overflow-y-auto w-full pr-2">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/5 rounded-[2.5rem] overflow-hidden shadow-sm">
